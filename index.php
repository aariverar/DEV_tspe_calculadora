<!DOCTYPE html>
<?php
  $mysqli = new mysqli('localhost:3307', 'root', 'Tsoft2021', 'tspe_h_estimacion');
?>
<html>
	<head>
		<title>TSOFT Perú Estimación</title>
    ...
    <div style="text-align:center; width:750px;height:0px; margin-left:auto; margin-right:auto; margin-bottom:1%; border:0px solid #000;font-size:30px; font-family:verdana;font-weight:bold">Herramienta de Estimación TSOFT PERÚ</div>
   	</div>
